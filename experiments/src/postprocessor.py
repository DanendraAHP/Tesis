...
class PostProcessor:
    def __init__(self, use_postprocess):
        ...
        self.aspect_categories = ['price', 'produk', 'payment', 'website&apps', 'delivery', 'customerservice']
    ...
    def post_process(self, aspect_term:str, opinion_term:str, sentiment:str, aspect_category:str, orig_sentence:str)->str:
